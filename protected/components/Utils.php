...
class Utils{
	...
	public static function getRemoteSystemInfo(){
		...
		$client['platform'] = Utils::determineplatform($client['userAgent']);
		$client['browser'] = Utils::determinebrowser($client['userAgent']);
		return $client;
	}
	...
	public static function determinebrowser ($Agent) {
		...
		}else if (ereg( 'Chrome/([0-9.]{1,13})',$Agent,$version)) {
			$browserversion=$version[1];
			$browseragent="Chrome";
		}
